...
This document is the original README chronology: Phase 1 (PCAP → features) and Phase 2 (modeling, calibration, V1 freeze, assessment). The landing [README](../README.md) describes the finished serving system. Frozen contracts, metrics, and CLI commands below are still authoritative for reproduction.
